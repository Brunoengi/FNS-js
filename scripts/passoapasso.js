...
function armaduraDupla(){
    let buttonP4 = document.getElementById('buttonP4')
    buttonP4.innerText="Passo 4: Determinar as áreas de armadura (Dupla)"
    // TODO: Implementar a lógica para exibir os cálculos do passo a passo da armadura dupla.
    let info4_5 = document.getElementById('info4_5')
    info4_5.innerHTML = "Teremos armadura dupla: A<sub>s</sub>= " + aas.toFixed(2) + " cm² e A'<sub>s</sub>= " + asl.toFixed(2) + " cm²"
}
